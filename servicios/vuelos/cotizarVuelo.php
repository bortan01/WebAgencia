                                       ...
                                       <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="ciudad_partida"
                                                id="ciudad_partida" placeholder="Ejemplo: San Salvador, El Salvador">
                                          </div>
                                       </div>
                                       <div class="col-sm-3">
                                          <!-- text input -->
                                       ...
                                       <div class="col-sm-12">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control" name="ciudad_destino"
                                                id="ciudad_destino" placeholder="Ejemplo: Los Angeles, Estados Unidos">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="row">
                                       <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input disabled type="text" class="form-control" name="ciudad_llegada"
                                                id="ciudad_llegada" placeholder="Ejemplo: Los Angeles, Estados Unidos">
                                          </div>
                                       </div>
                                       <div class="col-sm-3">
                                          <!-- text input -->
                                          <div class="form-group">
                                             ...
                                             <input disabled type="date" class="form-control" name="fechaLlegada"
                                                id="fechaLlegada">
                                          </div>
                                       </div>
                                       <div class="col-sm-3">
                                          ...
                                          <div class="input-group clockpicker" data-autoclose="true">
                                             <input disabled type="text" id="timepicker2" name="start"
                                                class="form-control" value="08:00" readonly />
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             ...
                                             <input type="number" class="form-control" name="maletaMa" id="maletaMa">
                                          </div>
                                       </div>
                                       <div class="col-sm-4">
                                          <div class="form-group">
                                             <label>Equipaje de Bodega (Máx 23kg)</label>
                                             <input type="number" class="form-control" name="maletaBo" id="maletaBo">
                                          </div>
                                       </div>
                                       <div class="col-sm-4">
                                          <div class="form-group">
