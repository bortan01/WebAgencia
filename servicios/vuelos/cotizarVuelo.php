                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group multiple-form-group input-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input disabled="true" type="text" name="cliente"
                                                                    id="cliente" class="form-control" autocomplete="off"
                                                                    placeholder="Cliente">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="bebes"
                                                                id="bebes">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                placeholder="Insertar Nueva Opcion" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <br>
