                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="py-2 px-3 mt-4" style="background-color: #0069d9; color:white">
                                        <div class="centrar">
                                            <h3 style="color: white;text-align: center;" class="mb-0" name="titulo"
                                                id="titulo">
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-block btn-success btn-flat" id="btnItinerario"
                                            name="btnItinerario" id="btnItinerario">
                                ...
                                <nav class="w-100">
                                    <div class="nav nav-tabs" role="tablist">
                                        <a class="nav-item nav-link active" data-toggle="tab" href="#tab-descripcion"
                                            role="tab" aria-selected="true">Descripción</a>
