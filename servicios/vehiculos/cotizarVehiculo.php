                                                    ...
                                                    <div class="timeline-body">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" min=2010
                                                                        max=<?php echo date("Y"); ?> name="anio"
                                                                        id="anio" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        placeholder="Digite dirección de recogida"
                                                                        autocomplete="off">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-3">
                                                        ...
                                                        <div class="timeline-footer" style="text-align: right;">
                                                            <button name="btnGuardarCotizacionV"
                                                                id="btnGuardarCotizacionV" class="btn btn-info btn-sm"
