                  ...
                  <div class="well-middle">
                     <div class="single-well">
                        ...
                        <p style="text-align: justify;">
                           This privacy policy governs the use of the Martinez Travels & Tours software application for
                           Android mobile devices that was created by Boris Ricardo Miranda Ayala.

                           What information do we collect?
                           The application collects personal information such as name, surname, email, profile picture,
                           etc.
                           We use the information only to create a user profile.

                           Contact
                           To contact us please use the email: brmiranda009@gmail.com.
                        </p>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="footer-content">
                     <div class="footer-head">
                        ...
                        <div class="footer-contacts">
                           <p>
                              <span>Ubicación: </span>
                              <span style="color: #444; font-weight: 200;" name="direccion_a" id="direccion_a"></span>
                           </p>
