...
<body data-spy="scroll" data-target="#navbar-example">
        ...
        <main id="main">
            <div id="site-content">
                <main class="content">
                    <div class="slider">
                        <ul class="slides">
                            <li data-background="assets/img/slider/plaza_libertad.png">
                                <div class="container">
                                    <div class="slide-caption col-md-4">
                                        <h2 class="slide-title">Tours Aéreos</h2>
                                        <p>Adquire tus tours favoritos con nosotros y haz realidad tus sueños en Centro
                                            América, Sudamérica y Europa.
                                        </p>
                                        <a href="servicios/paquetes/disponibles.php" class="button">ver Tours Aéreos</a>
                                    </div>
                                </div>
                            </li>
                            <li data-background="assets/img/slider/volcanes.png">
                                <div class="container">
                                    <div class="slide-caption col-md-4">
                                        <h2 class="slide-title">Tours Terrestres</h2>
                                        <p>Tú elige el destino, nosotros te llevamos! haz realidad tus sueños viajando a
                                            Centro América, Sudamérica y Europa.</p>
                                        <a href="servicios/tours/disponibles.php" class="button">ver Tours
                                            Terrestres</a>
                                    </div>
                                </div>
                            </li>
                            <li data-background="assets/img/slider/surf_city.jpg">
                                <div class="container">
                                    <div class="slide-caption col-md-4">
                                        <h2 class="slide-title">Asesoría Migratora</h2>
                                        <p>Somos profesionales en El Salvador en asesoría sobre trámites migratorios
                                            hacia los Estados Unidos. ¡Agenda tu cita!
                                        </p>
                                        <a href="servicios/asesoria/cita.php" class="button">Agendar cita para
            ...
            <!-- ======= contenedor Hotel ======= -->
            <div id="hoteles" class="hoteles-area area-padding">
                <div class="">
                    <div class="">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="section-headline services-head text-center">
                    ...
                    <div class="container">
                        <section class="content">
                            <form id="imagenHotel" name="imagenHotel" role="form" onsubmit="return false">
                                <div class="container">
                                    <div class="row" id="contenedorHotel">
                                        <!-- Hover-Fall Efecto-->
                ...
                <form id="miFormularioHotel" name="miFormularioHotel" role="form" onsubmit="return false">
                    <!-- Modal EDITAR-->
                    <div class="modal fade" id="modal-editarHotel">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div id="imagenesPequenasHotel" class="col-12 product-image-thumbs">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="bg-primary py-2 px-3 mt-4">
                                                        <div class="centrar">
                                                            <h6 style="color:#FFFFFF">Precio por Noche: $</h6>
                                                            <h6 style="color:#FFFFFF" class="mb-0" name="precioN"
                                                                id="precioN" style="text-align:center"></h6>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="footer-content">
                                <div class="footer-head">
                                    ...
                                    <p style="color: #444; font-weight: 200;">Síguenos en todas nuestras redes sociales
                                        para
    ...
    <script src="assets/js/controladores/hoteles/disponibilidadHotel.js"></script>
